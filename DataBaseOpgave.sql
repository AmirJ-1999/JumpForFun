...
USE JumpForFunDataBase; -- Kør scriptet "USE JumpForFunDataBase" for at vælge Databasen, og derefter benyt SELECT til at fremvise en tabel, som for eksempel: SELECT * FROM Booking;
...
VALUES ('intensiv hop', 20, '2024-11-30 11:00:00', '2024-11-30 12:00:00', 1, 1),
       ('Yoga øvelse', 25, '2024-11-30 13:00:00', '2024-11-30 14:00:00', 2, 2);
...
-- Viser alle træningssessioner, deres trænere og træningsrum
SELECT 
